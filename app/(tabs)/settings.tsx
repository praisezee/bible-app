      ...
      <ScrollView className="flex-1 p-4">
        ...
        >
          ...
          <TouchableOpacity
            ...
            style={{
              backgroundColor:
                settings.theme === 'system' ? colors.accent : colors.background,
              borderWidth: 1,
          ...
          <TouchableOpacity
            ...
            style={{
              backgroundColor:
                settings.theme === 'light' ? colors.accent : colors.background,
              borderWidth: 1,
              borderColor: colors.border,
            }}
          ...
          {/* <TouchableOpacity
            ...
            style={{
              backgroundColor:
                settings.theme === 'custom' ? colors.accent : colors.background,
              borderWidth: 1,
              borderColor: colors.border,
            }}
          ...
          >
            <View className="flex-row items-center flex-1">
              <Palette
                size={24}
                color={settings.theme === 'custom' ? '#ffffff' : colors.text}
              />
              <Text
                className="ml-3 font-medium"
                style={{
                ...
                {[12, 14, 16, 18, 20, 22, 24].map((size) => (
                  ...
                  >
                    <Text
                      ...
                      style={{
                        color:
                          settings.fontSize === size ? '#ffffff' : colors.text,
                      }}
                    >
                      {size}
                    </Text>
        ...
        >
          ...
          <Text className="text-sm" style={{ color: colors.text + 'CC' }}>
            Offline-first design ensures your data stays private and accessible
          </Text>
          <Text className="text-sm" style={{ color: colors.text + 'CC' }}>
